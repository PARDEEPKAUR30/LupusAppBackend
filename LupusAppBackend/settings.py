"""
Django settings for LupusAppBackend project.
...
# SECRET_KEY = 'django-insecure-9f0miov=220kx2pnclp*+5z(8#s9e&d2b4wb0zh%lv^pu2m7lk'
...
WSGI_APPLICATION = 'LupusAppBackend.wsgi.application'
