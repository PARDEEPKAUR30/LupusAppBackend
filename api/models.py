...
class LupusData(models.Model):
    ...
    antiDsDNA=models.CharField(max_length=10,default="No") 
    antiSmith=models.CharField(max_length=10,default="No") 
    hemolysis=models.CharField(max_length=10,default="No")
